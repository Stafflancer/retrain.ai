...
wp_enqueue_style('simple_icons_css', get_template_directory_uri() . '/static/css/modules/simple_icons/simple_icons.css', [], null);
wp_enqueue_script( 'simple_icons_js', get_template_directory_uri() . '/static/js/modules/simple_icons/simple_icons.js', [], null );

?>
<section class="<?php if ($media_type == 'image' && !empty($image) && $parallax) { echo 'prallax-added'; } ?> simple_icons <?php 
		...
		<div class="simple_icons_inner">
			<div class="simple_icons_grid row"><?php 
				...
				while (have_rows('columns')) 
				{
					...
					<div class="simple-icons-block col-sm-6 col-lg-4 text-center"><?php
						if($column_icon)
						{ ?>
							<div class="simple_icons_image">
								<img src="<?php echo $column_icon; ?>">
							</div><?php 
						} 
						if($column_heading){ ?>
							<h2 class="simple_card_heading"><?php echo $column_heading; ?></h2><?php 
						} ?>
					</div>
				<?php 
				}
