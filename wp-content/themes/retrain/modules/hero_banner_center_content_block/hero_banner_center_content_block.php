...
wp_enqueue_script('hero_banner_common_content_block', get_template_directory_uri() . '/static/js/modules/hero_banner_center_content_block/hero_banner_center_content_block.js', '', '', true);
// Setup defaults.
$args = [
	'container'       => 'section',
		...
		<div class="hero-background-inner">
			<div class="row align-items-center">
				<div class="col-12">
					...
					<?php } ?>
					<div class="text-white hero-banner-content <?php echo $content_text_color; ?> text-center"><?php echo $content; ?></div>
					<?php if ( $button ) { ?>
