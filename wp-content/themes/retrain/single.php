...
while ( have_posts() ) : the_post();
	...
	$formid = get_field('download_form');
	?>
	...
	<section class="blog-single">
			...
			<div class="back-section">
				<div class="row">
					<div class="col-12 col-lg-12">
						...
						<?php if($posttype == 'press-releases'){
							?>
							<a href="<?php echo home_url('company/press'); ?>" class="backbtn bc">Back to Press</a>
							<?php

							}else{?>
							<a href="<?php echo $blogpageurl; ?>" class="backbtn bc">Back to Resources</a>
					  <?php } ?>
					</div>
				</div>
			</div>
			<div class="single-blog-topbar">
				...
				<div class="single-blog-image">
					<div class="row">
						...
						<?php if($enable_form == 'yes' && !empty($formid)){ ?>
						...
						<div class="col-12 col-lg-5">
							<div class="banner-img postdownloadform">						
								<div class="bookdemo-gravity-form">
								<?php echo do_shortcode( '[gravityform id="' . $formid . '" title="true" ajax="true"]' ); ?>
								</div>
							</div>
						</div>
					<?php }else{
		...
		<div class="content-blog-single">
			...
			if($display_position == 'bottom_content'){ 
				?>
			...
			if($display_position == 'above_content'){
				?>
					<div class="blog-content">
						<?php the_content(); ?>
					</div>
